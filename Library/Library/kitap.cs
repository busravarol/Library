    ...
    public partial class kitap : Form
    {
      ...
      /*  public static MySqlConnection GetConnection()
       ...
       /* public class kitap
        ...
        {
            baglanti.Open   ();
            MySqlCommand komut = new MySqlCommand("insert into tbl_kitap(ID,kitapadi,ISBN,kategori,yayintarihi,yayinevi,sayfasayisi,yazaradi) values (@k1,@k2,@k3,@k4,@k5,@k6,@k7) ", baglanti);
            komut.Parameters.AddWithValue("@k1", txt_Ad.Text);
            komut.Parameters.AddWithValue("@k2", txt_ISBN.Text);
            komut.Parameters.AddWithValue("@k3", txt_Kategori.Text);
            komut.Parameters.AddWithValue("@k4", txt_Tarih.Text);
            komut.Parameters.AddWithValue("@k5", txt_Yayinevi.Text);
            komut.Parameters.AddWithValue("@k6", txt_Ss.Text);
            komut.Parameters.AddWithValue("@k7", txt_Yazar.Text);
