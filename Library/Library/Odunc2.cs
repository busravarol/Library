...
namespace Library
{
    public partial class Odunc2 : Form
    {
        ...
        private void btn_Teslim_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            MySqlCommand komut = new MySqlCommand("insert into  tbl_odunc(ograd,ogrsoyad,ogrtelefon,ogreposta,ogrbolumad,kitapadi,teslimalinantarih,teslimverilecektarih) values (@k1,@k2,@k3,@k4,@k5,@k6,@k7, null) ", baglanti);
